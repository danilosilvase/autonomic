...
#os.system('docker network create -d overlay --attachable=true redeautonomic\n')
...
host = workers_node[workers_node_names[2]]["node"]
user = workers_node[workers_node_names[2]]["user"]
